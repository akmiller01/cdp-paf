...
dataset = load_dataset("csv", data_files="large_data/data_for_false_positive_distinction_training.csv", split="train")
...
dataset = dataset.remove_columns(['clean_text', 'PAF keyword match', 'class_label'])
...
for label in unique_labels:
    positive_filtered_dataset = dataset.filter(lambda example: label == example['label'])
