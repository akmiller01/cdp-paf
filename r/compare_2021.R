...
auto = fread("large_data/crs_2021_cdp_automated.csv")
...
fwrite(missed_aa, "data/missed_2021_aa.csv")
fwrite(new_aa, "data/new_2021_aa.csv")
...
fwrite(missed_paf, "data/missed_2021_paf.csv")
fwrite(new_paf, "data/new_2021_paf.csv")
...
fwrite(missed_cf, "data/missed_2021_cf.csv")
fwrite(new_cf, "data/new_2021_cf.csv")
